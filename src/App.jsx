              ...
              <div className={styles.modal_content}>
                  ...
                  <div className={styles.modal_contnet_image}>
                    <div className={styles.modal_contnet_image_inner}>
                      <picture>
                          ...
                          {theme === "dark" ? <img src={FallbackImage} alt="Fallback Image" width="600"/>:
                          <img src={FallbackImageLight} alt="Fallback Image" width="600"/>}
                      </picture>
                    </div>
                  </div>
                </div>
                <div className={styles.modal_contnet_col}>
                  ...
                  <div className={styles.modal_row}>
                    ...
                    <Typography type="p">
                      {modalInfo.researchFields}
                    </Typography>
                  </div>
                </div>
              </div>
              <button className={styles.modal_close} onClick={closeModal}>
                <svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="20" height="20" transform="translate(1 1)" fill="none"></rect><path d="M1 1L21 21" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M21 1L1 21" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
              </button>
            </div>
        </Modal>
