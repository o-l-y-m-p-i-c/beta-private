...
import { bearerToken, PUBLIC_API_URL } from "../../constants/api";
...
export const Graph = () => {
  ...
  useEffect(() => {
    ...
    axios({
      method: "GET",
      url: `${PUBLIC_API_URL}/articles/article?articleId=${graphID - 1}`,
      headers: {
            ...
            <>
              ...
              <section className={styles.inner_content}>
                ...
                <div className={styles.graph} ref={parentRef}>
                  ...
                  {graph?.graphDraft && graph?.graph.length === 0 && (
                    <Graph3D
                      parentRef={parentRef}
                      isFetching={isFetching}
                      links={[
